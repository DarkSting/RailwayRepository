...
class TrainBoxCardStyle2 extends StatefulWidget {
  @override
  _TrainBoxCardStyle2State createState() => _TrainBoxCardStyle2State();
}

class _TrainBoxCardStyle2State extends State<TrainBoxCardStyle2> {
